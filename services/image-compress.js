...
const MAX_SIDE = Math.min(4096, Math.max(400, parseInt(process.env.OCR_IMAGE_MAX_SIDE || '1280', 10) || 1280));
const WEBP_QUALITY = Math.min(100, Math.max(40, parseInt(process.env.OCR_IMAGE_WEBP_QUALITY || '82', 10) || 82));
